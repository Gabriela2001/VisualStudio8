...
Partial Public Class TECNOFACILDataSet
    ...
    Partial Public Class ProductosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductosRow(ByVal Nombre As String, ByVal Precio As Decimal, ByVal Marca As String, ByVal Fecha_Entrada As Date, ByVal Fecha_Salida As Date, ByVal Descripcion As String) As ProductosRow
            Dim rowProductosRow As ProductosRow = CType(Me.NewRow,ProductosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nombre, Precio, Marca, Fecha_Entrada, Fecha_Salida, Descripcion}
...
Namespace TECNOFACILDataSetTableAdapters
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Productos` WHERE ((`Codigo` = ?) AND ((? = 1 AND `Nombre` IS NULL) O"& _ 
                "R (`Nombre` = ?)) AND ((? = 1 AND `Precio` IS NULL) OR (`Precio` = ?)) AND ((? ="& _ 
                " 1 AND `Marca` IS NULL) OR (`Marca` = ?)) AND ((? = 1 AND `Fecha_Entrada` IS NUL"& _ 
                "L) OR (`Fecha_Entrada` = ?)) AND ((? = 1 AND `Fecha_Salida` IS NULL) OR (`Fecha_"& _ 
                "Salida` = ?)) AND ((? = 1 AND `Descripcion` IS NULL) OR (`Descripcion` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Productos` (`Nombre`, `Precio`, `Marca`, `Fecha_Entrada`, `Fecha_Sal"& _ 
                "ida`, `Descripcion`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Productos` SET `Nombre` = ?, `Precio` = ?, `Marca` = ?, `Fecha_Entrada` ="& _ 
                " ?, `Fecha_Salida` = ?, `Descripcion` = ? WHERE ((`Codigo` = ?) AND ((? = 1 AND "& _ 
                "`Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Precio` IS NULL) OR (`Prec"& _ 
                "io` = ?)) AND ((? = 1 AND `Marca` IS NULL) OR (`Marca` = ?)) AND ((? = 1 AND `Fe"& _ 
                "cha_Entrada` IS NULL) OR (`Fecha_Entrada` = ?)) AND ((? = 1 AND `Fecha_Salida` I"& _ 
                "S NULL) OR (`Fecha_Salida` = ?)) AND ((? = 1 AND `Descripcion` IS NULL) OR (`Des"& _ 
                "cripcion` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Codigo, Nombre, Precio, Marca, Fecha_Entrada, Fecha_Salida, Descripcion FR"& _ 
                "OM Productos"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As TECNOFACILDataSet.ProductosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As TECNOFACILDataSet.ProductosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As TECNOFACILDataSet.ProductosDataTable = New TECNOFACILDataSet.ProductosDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As TECNOFACILDataSet.ProductosDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As TECNOFACILDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Codigo As Integer, ByVal Original_Nombre As String, ByVal Original_Precio As Global.System.Nullable(Of Decimal), ByVal Original_Marca As String, ByVal Original_Fecha_Entrada As Global.System.Nullable(Of Date), ByVal Original_Fecha_Salida As Global.System.Nullable(Of Date), ByVal Original_Descripcion As String) As Integer
            ...
            If (Original_Fecha_Entrada.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_Fecha_Entrada.Value,Date)
            Else
            ...
            If (Original_Fecha_Salida.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_Fecha_Salida.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Nombre As String, ByVal Precio As Global.System.Nullable(Of Decimal), ByVal Marca As String, ByVal Fecha_Entrada As Global.System.Nullable(Of Date), ByVal Fecha_Salida As Global.System.Nullable(Of Date), ByVal Descripcion As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Nombre As String, ByVal Precio As Global.System.Nullable(Of Decimal), ByVal Marca As String, ByVal Fecha_Entrada As Global.System.Nullable(Of Date), ByVal Fecha_Salida As Global.System.Nullable(Of Date), ByVal Descripcion As String, ByVal Original_Codigo As Integer, ByVal Original_Nombre As String, ByVal Original_Precio As Global.System.Nullable(Of Decimal), ByVal Original_Marca As String, ByVal Original_Fecha_Entrada As Global.System.Nullable(Of Date), ByVal Original_Fecha_Salida As Global.System.Nullable(Of Date), ByVal Original_Descripcion As String) As Integer
            If (Nombre Is Nothing) Then
            ...
            If (Original_Fecha_Entrada.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_Fecha_Entrada.Value,Date)
            Else
            ...
            If (Original_Fecha_Salida.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_Fecha_Salida.Value,Date)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As TECNOFACILDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As TECNOFACILDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As TECNOFACILDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As TECNOFACILDataSet) As Integer
